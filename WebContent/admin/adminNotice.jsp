...
Buy better, keep forever.
       ...
       <div  align="center">
	        ...
	        <a href ="adminNotice.jsp?pageNumber= <%=pageNumber - 1%>" style="font-size: medium; margin: 10px;"> 이전 </a>
	        <%
	        	}if(nmgr.nextPage(pageNumber + 1)){
	        %>

	        <a href ="adminNotice.jsp?pageNumber= <%=pageNumber + 1%>" style="font-size: medium; margin: 10px;"> 다음 </a>
	        ...
	        if(sid.equals("root")) {
	        %>
	         <a href ="NWrite.jsp" style="font-size: medium; margin: 10px;"> 글쓰기</a>
